...
const ClientHeader = () => {
  return (
    <header className="w-full h-[60px] bg-white shadow-md">
      <div className="max-w-[1280px] mx-auto px-6 h-full flex items-center justify-between">
        ...
        <nav className="flex items-center space-x-8 text-sm font-medium uppercase">
          <div className="relative group cursor-pointer">
            <span className="hover:text-gray-700">Nam <i className="fas fa-angle-down ml-1"></i></span>
          </div>
          <div className="relative group cursor-pointer">
            <span className="hover:text-gray-700">Nữ <i className="fas fa-angle-down ml-1"></i></span>
          </div>
          <div className="relative group cursor-pointer">
